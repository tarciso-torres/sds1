...
import com.devsuperior.dspesquisa.dto.RecordInserDTO;
...
public class RecordResource {
	...
	@PostMapping
	public ResponseEntity<RecordDTO> insert(@RequestBody RecordInserDTO dto) {
		RecordDTO recordDto = service.insert(dto);
		URI uri = ServletUriComponentsBuilder
				.fromCurrentRequest()
				.path("/{id}")
				.buildAndExpand(recordDto.getId())
				.toUri();
